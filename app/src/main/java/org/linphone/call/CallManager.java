...
import static org.linphone.LinphoneContext.prt;
...
public class CallManager {
    ...
    public boolean acceptCall(Call call) {
        ...
        Core core = LinphoneManager.getCore();
        CallParams params = core.createCallParams(call);
        prt("CallManager.acceptCall: params "+params);
        ...
        prt("CallManager.acceptCall: before acceptWithParams");
        call.acceptWithParams(params);
        prt("CallManager.acceptCall: after acceptWithParams");
        return true;
    }
