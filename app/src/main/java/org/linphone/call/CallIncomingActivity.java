...
public class CallIncomingActivity extends LinphoneGenericActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (doNotUseSliders /*RAF && !mKeyguardManager.inKeyguardRestrictedInputMode()*/) {
    ...
    private void answer() {
        ...
        prt("CallIncomingActivity.answer before acceptCall "+mCall);
        if (!LinphoneManager.getCallManager().acceptCall(mCall)) {
            // the above method takes care of Samsung Galaxy S
            Toast.makeText(this, R.string.couldnt_accept_call, Toast.LENGTH_LONG).show();
        }
        prt("CallIncomingActivity.answer after acceptCall "+mCall);
    }
