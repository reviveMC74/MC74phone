...
public class CallOutgoingActivity extends LinphoneGenericActivity implements OnClickListener {
    ...
    public static String NAME = "outgoing";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        } catch (Throwable th) { // RAF
            prt("CallOutgoingActivity onCreate Ex: " + th);
            prt("" + th.getStackTrace());
        }
        ...
        if (mMicro == null) return; // RAF --if setContentView Failed, return before using mMicro
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.speaker) {
            ...
            // Signal to SSM speakerMode, expect/ignore an OnHook event
            SSMcmd.ssmCmdReply(null, "speakerMode on");
        }
