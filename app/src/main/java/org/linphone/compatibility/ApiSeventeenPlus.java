...
// Fix compatibility differences between API17 and API21, Copied from ApiTwentyOnePlus.java
//  Used in Compatibility.java   createNotification

@TargetApi(17)
class ApiSeventeenPlus {
    ...
    public static Notification createNotification(
        ...
        System.out.println("RAF API17+ createNotification " + title);
        if (largeIcon != null) {
            notif =
                    new Notification.Builder(context)
                            ...
                            .setContentIntent(intent)
                            // .setCategory(Notification.CATEGORY_SERVICE)  -- API21
                            // .setVisibility(Notification.VISIBILITY_SECRET)  --API21
                            .setLights(
                                    ContextCompat.getColor(context, R.color.notification_led_color),
                                    context.getResources().getInteger(R.integer.notification_ms_on),
